...
const csvSampleTimeseries = [
  ['Instrument', 'Name', 'Parameter', 'Unit'],
  [
    'My Example Piezometer 1A',
  ...
  ['My Example Piezometer 1A', 'My Example Timeseries 1B', 'Voltage', 'Volts'],
];
    ...
    const buildContent = (title, csvData, notes) => (
      <div>
        <div className='float-right'>
          <DownloadCSVButton csvContent={csvData} filename={`${title}.csv`} />
        </div>
        <CSV arr={csvData} />
        <section className='section has-background-'>{notes}</section>
      </div>
    );
    ...
    const tabs = [
      ...
      },
      {
        ...
        content: buildContent(
          ...
          csvSampleTimeseriesMeasurements,
          <NotesTimeseriesMeasurements />
        ),
      },
      {
        ...
        content: buildContent(
          ...
          csvSampleInclinometerMeasurements,
          <NotesInclinometerMeasurements />
        ),
      },
    ];
      ...
      <Card>
        <Card.Body>
          ...
          <p className='text-muted'>
            Glad you asked! The site supports .csv uploads of Instruments,
            Timeseries, Timeseries measurements and Inclinometer measurements at
            this time. Uploaders for Projects are coming soon. To get organized,
