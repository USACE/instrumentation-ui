...
const AlertEntry = connect(
  ...
  ({
    ...
    const toggleRead = (...params) => {
      isRead ? doAlertUnreadSave(...params) : doAlertReadSave(...params);
    };
            ...
            >
              ...
              {isHovered && (
                <div
                  ...
                  style={{ marginTop: '-17px', marginRight: '-21px' }}
                >
                  <Button
                    variant='info'
                    size='small'
                    ...
                    icon={
                      <Icon icon={isRead ? 'eye-off-outline' : 'eye-outline'} />
                    }
                  />
                  <Button
                    variant='info'
