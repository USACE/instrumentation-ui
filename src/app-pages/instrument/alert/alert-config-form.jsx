...
const AlertConfigSettings = connect(
  ...
  ({
    ...
    const subscription = profileAlertSubscriptions.find(
      (e) => e.alert_config_id === item.id
    );
      ...
      <div className='modal-content' style={{ overflowY: 'auto' }}>
        ...
        <section className='modal-body'>
          <div className='form-group row mt-2'>
            <label htmlFor='alertNameInput' className='col-sm-2 col-form-label'>
              Name
            </label>
            <div className='col-sm-10'>
              <input
                ...
                onChange={(e) =>
                  setConfigSettings({ ...configSettings, name: e.target.value })
                }
              />
            </div>
          </div>
          ...
          <div className='form-group row'>
            <label htmlFor='userSubscribe' className='col-sm-3'>
              Subscribed
            </label>
          ...
          {!!subscription && (
            <>
              <div className='form-group row'>
                <label htmlFor='userMuteUI' className='col-sm-3 mb-0'>
                  Mute UI
                </label>
                <div className='col-sm-9'>
                  <div className='form-check'>
                ...
                <small id='muteUiHelp' className='ml-3 form-text text-muted'>
                  Enable this option to silence alerts on the User Interface.
                </small>
              </div>
              <div className='form-group row'>
                <label htmlFor='userMuteNotify' className='col-sm-3 mb-0'>
                  Mute Notify
                </label>
                <div className='col-sm-9'>
                  <div className='form-check'>
                    <input
                      ...
                      onChange={() =>
                        setUserPreferences({
                          ...userPreferences,
                          muteNotify: !userPreferences.muteNotify,
                        })
                      }
                    />
                  </div>
                ...
                <small
                  id='muteNotifyHelp'
                  className='ml-3 form-text text-muted'
                >
                  Enable this option to stop email notifications.
                </small>
              </div>
            </>
          )}
