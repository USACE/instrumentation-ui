...
export default createRestBundle({
  ...
  putTemplate: '/projects/:project_id/instruments/:instrument_id/constants/:item.id',
  postTemplate: '/projects/:project_id/instruments/:instrument_id/constants',
  deleteTemplate: '/projects/:project_id/instruments/:instrument_id/constants/:item.id',
  fetchActions: [],
