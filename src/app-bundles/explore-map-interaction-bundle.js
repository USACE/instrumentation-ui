...
const exploreMapInteractionBundle = {
  ...
  doExploreMapInteractionsInitialize:
    () =>
    ({ dispatch, store }) => {
      dispatch({
  ...
  doExploreMapInteractionsRemoveAll:
    () =>
    ({ store }) => {
      const mapKey = store.selectExploreMapKey();
      const map = store.selectMapsObject()[mapKey];
  ...
  doExploreMapInteractionsSelectByArea:
    () =>
    ({ store }) => {
      /**
  ...
  selectExploreMapInteractionsVersion: (state) =>
    state.exploreMapInteractions.version,
  ...
  selectExploreMapInteractionsSelect: (state) =>
    state.exploreMapInteractions.select,

  selectExploreMapInteractionsDragBox: (state) =>
    state.exploreMapInteractions.dragBox,
